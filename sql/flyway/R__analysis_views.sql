...
FROM WORK_ORDER_SUMMARY WHERE current_status = 'CLOSED' AND technician_id IS NOT NULL GROUP BY technician_id;
...
FROM WORK_ORDER_SUMMARY WHERE current_status = 'CLOSED' GROUP BY 1;
